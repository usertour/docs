...
| `atLeast` | `object{ duration, unit }` |  | Quiet period across content: only auto-start if no OTHER content has been shown within this window — avoids showing a user too many things at once. |
