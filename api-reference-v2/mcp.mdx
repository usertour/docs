...
| Localizations         | `list_localizations`, `get_version_localization`                           |
...
| Localizations         | `update_version_localization` — see [Localization](/how-to-guides/localization#translate-via-the-api-or-mcp)                         |
