...
- **Project** — the one project the connection may act in (fixed when you only
  have one).
- **Environment access** — which of that project's environments it can act on.
...
| Localizations         | `list_localizations`                                                       |
| Version translations  | `get_version_localization`                                                 |
...
| Localizations         | `create_localization`, `update_localization`, `delete_localization`, `restore_localization`                                          |
| Version translations  | `update_version_localization` — see [Localization](/how-to-guides/localization#translate-via-the-api-or-mcp)                         |
