...
Place your tooltips exactly where you want them:

- Choose from multiple positions (left, right, above, below)
- If space is limited, it'll automatically find the best position
- See the positioning in real-time in the builder
