...
If you're using the standard self-hosted Docker deployment, Usertour seeds a bootstrap admin account when the database is still empty.

- Email: `lisa@simpson.com`
- Password: `secret42`

This seeded user is the default `System Admin` for the instance.

After your first login, open **System Admin** from the account menu to manage:
