...
| **Other Configuration** |||
| LOGIN_REDIRECT_URL | Yes | URL to redirect after login |
| USERTOUR_COOKIE_DOMAIN | Yes | Domain where cookies are valid and can be accessed |
...
USERTOUR_COOKIE_DOMAIN=localhost
```
