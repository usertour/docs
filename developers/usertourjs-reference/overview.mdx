...
| Method                         | Purpose                                     |
| ------------------------------ | ------------------------------------------- |
| [usertour.init() ](/developers/usertourjs-reference/setup/init)     | Initialize Usertour.js with your Token️     |
| [usertour.identify() ](/developers/usertourjs-reference/users/identify) | Identify a user️                            |
| [usertour.group() ](/developers/usertourjs-reference/companies/company)    | Associate current user with a group/company |
