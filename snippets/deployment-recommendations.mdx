...
For production deployments, we do **not** recommend using Docker Compose. Instead:
...
- Deploy only the Usertour application using the published [Docker Hub](https://hub.docker.com/r/usertour/usertour/) image
</Warning> 