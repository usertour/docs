---
title: Overview
description: Connect Usertour to your analytics tools, your CRM, and Zapier — stream events out as they happen, sync cohorts and CRM properties back in.
icon: "plug"
---

Integrations connect Usertour to the rest of your stack:
...
- **CRM properties, both ways.** [HubSpot](/integrations/hubspot) contacts and companies link to Usertour users and companies; CRM properties become targeting attributes, and onboarding data is written back to the CRM record.
- **Automation.** [Zapier](/integrations/zapier) triggers Zaps from Usertour events and creates or updates users, companies, and events from thousands of apps.

Each analytics provider has its own page with setup steps and provider-specific notes: [Amplitude](/integrations/amplitude), [Heap](/integrations/heap), [Mixpanel](/integrations/mixpanel), [PostHog](/integrations/posthog), [Segment](/integrations/segment). The rest of this page describes the analytics providers; HubSpot and Zapier connect differently and are covered on their own pages.
