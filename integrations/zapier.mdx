...
2. In Usertour, create an API token under **Settings → API**. Give it the **Webhooks: manage** scope for triggers, plus **Users: write** if you use the actions, and include the environments you want to connect.
