...
<Note>
  SSO is configured **per project** by a project **Owner** or **Admin**, under **Settings → SSO**. It requires a **Business** plan (cloud) or an **active license** (self-hosted). Without it, the SSO settings page shows an upgrade prompt.
</Note>
