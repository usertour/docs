...
#### Add Users to Manual Segments

Need to add more users to a manual segment later? You can do that directly from the Users list:

1. Go to the Users page
2. Select one or more users using the checkboxes
3. Click **Add to manual segment** above the table
4. Choose the manual segment you want to update
5. Confirm to add the selected users

![](/images/add-user-segment-02.png)
